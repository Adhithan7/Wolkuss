...
function App() {
  ...
  return (
    <div className="bg-[#000000] pt-3">
      <nav className="bg-[#000000] flex flex-wrap justify-evenly pt-3 pb-3 sticky top-0">
        <div className="flex items-center gap-1 mr-[7rem] w-[3rem] xl:w-[10rem] lg:mr-[3rem]">
          <img className="h-[35px] w-[35px]" src={play} alt="" />
          <h1 className="text-[1.2rem] text-white font-semibold">MovieFlix</h1>
        </div>
        <div className="sm:order-3 sm:flex sm:items-center xl:w-[12rem]">
          <button
            className="border-[1px] bg-[#161d29] px-2 py-1 mr-2 rounded-md text-white"
            onClick={loginPage}
          >
            {login}
          </button>
          <button
            className="border-[1px] bg-[#161d29] px-2 py-1 mr-1 rounded-md text-white"
            onClick={signup}
          >
            {mysignup}
          </button>
      ...
      <div className="app.js lg:w-[65rem] lg:mx-auto xl:w-[75rem] 2xl:w-[90rem]">
        ...
        <hr className="my-3" />
        <div className="giving-credit text-[white] text-center pb-5">@</div>
      </div>
    </div>
  );
}
